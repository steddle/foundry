...
description: "Simplify recently modified PHP/Laravel code for clarity, consistency and maintainability without changing its behaviour. Use after writing or changing code, or when asked to simplify, clean up or refine it. Works on the code touched in the current session unless told to look wider."
---
