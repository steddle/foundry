<x-layouts::site :title="'Lab | '.config('imprint.name')" description="The design system, the components and the experiments behind the site.">
    <x-site.sections.page-title title="Lab." lead="The design system, every component the site renders, and the questions still open, one page each.">
