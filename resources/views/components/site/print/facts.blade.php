...
{{--
    A document's particulars: label over value, in columns as wide as what they hold, spread across the line. Values set in tabular numerals, and a long one, a hash, breaks anywhere rather than overflow.
