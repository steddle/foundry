...
{{--
    One record in x-site.rows: its title with a status beside it, a line of
    ...
    <x-site.rows>
        <x-site.record-row href="#" title="Mutual NDA with Northwind" meta="Sent 21 Sep 2026 | 2 years + 3 years confidential">
            <x-slot:status><x-site.badge tone="warning" dot>Awaiting signature</x-site.badge></x-slot:status>
            <x-slot:actions><x-site.button href="#" variant="secondary">Resend</x-site.button></x-slot:actions>
        </x-site.record-row>
    </x-site.rows>
--}}
@php
