...
{{--
    ...
    <div class="flex flex-wrap items-center gap-2.5">
        <foundry:badge>Neutral</foundry:badge>
        <foundry:badge tone="info">Info</foundry:badge>
        <foundry:badge tone="success">Success</foundry:badge>
        <foundry:badge tone="warning">Warning</foundry:badge>
        <foundry:badge tone="danger">Danger</foundry:badge>
        <foundry:badge tone="action" dot>Action</foundry:badge>
    </div>
--}}
@php
    $tones = [
