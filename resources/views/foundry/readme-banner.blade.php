...
{{--
    ...
    @example Light
    @ground bare
    <foundry:readme-banner heading="A heading for the README." lede="What the repository holds, in a sentence." />

    @example Dark
    @ground bare
    <foundry:readme-banner heading="A heading for the README." lede="What the repository holds, in a sentence." dark />
--}}
<div @class([
    ...
    <foundry:mark class="absolute top-[96px] -right-[40px] size-[560px] text-zinc-950 dark:text-zinc-50 opacity-[0.05]" />

    <foundry:lockup class="relative h-[40px] self-start text-zinc-950 dark:text-zinc-50" />

    <div class="relative mt-[88px] flex max-w-[900px] flex-col">
        <p class="text-pretty font-serif text-[64px] leading-[1.08] font-semibold tracking-[-0.03em] text-zinc-950 dark:text-zinc-50"><foundry:marker :text="$heading" :marked="$marked" /></p>
        @if ($lede)
