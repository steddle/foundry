...
{{--
    ...
    <div class="flex flex-col gap-6">
        <foundry:heading size="display">Display heading.</foundry:heading>
        <foundry:heading size="figure">46.915</foundry:heading>
        <foundry:heading size="1">Heading one.</foundry:heading>
        <foundry:heading size="2">Heading two.</foundry:heading>
        <foundry:heading size="3">Heading three.</foundry:heading>
    </div>
--}}
@php
