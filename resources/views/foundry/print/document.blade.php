...
{{--
    ...
    @example A document
    @code
    <foundry:print.document title="Signing certificate" paper="A4" footer="Signing certificate | Mutual NDA">
        <foundry:print.masthead eyebrow="Signing certificate" title="Mutual Non-Disclosure Agreement" />
        <foundry:print.section title="The agreement">…</foundry:print.section>
