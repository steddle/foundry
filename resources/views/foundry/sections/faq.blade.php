...
{{--
    ...
    @ground bare
    <foundry:sections.faq eyebrow="Questions" title="What it is, and what it is not." :questions="[
        ...
        @foreach ($questions as $question)
            ...
            <details class="group border-b border-zinc-200 dark:border-zinc-700">
                <summary class="flex cursor-pointer list-none items-center justify-between gap-6 py-6 [&::-webkit-details-marker]:hidden">
                    <foundry:heading size="3" level="3">{{ $question }}</foundry:heading>
                ...
                <foundry:text class="max-w-[62ch] pb-8">{{ $answer }}</foundry:text>
            </details>
        @endforeach
    </div>
