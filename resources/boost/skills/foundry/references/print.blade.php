...
The page is `foundry:print.document` (`title`, `paper` A4 or Letter, `footer`): bone, 20 mm at the sides, the footer and the page count at the foot of every page, no heading left at the foot of a page and no paragraph broken with fewer than three lines on either side. It opens on `foundry:print.masthead`, ink bled to the paper's edge, and runs as `foundry:print.section`s holding `foundry:print.facts`; a section with `new-page`, a signature page, starts on a page of its own. The type scale is the site's, at a 12.5px rem.
