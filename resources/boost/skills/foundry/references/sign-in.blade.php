...
- `login.magic.send` (POST `login/magic`) mails `Steddle\Foundry\Auth\LoginLink`, queued on `imprint.auth.queue` where set, in the reader's language, on the mail theme and its greeting. The link is signed per account and works once, for 15 minutes.
